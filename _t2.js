...
console.log('desktop table rows:', main.querySelectorAll('table.painel-disciplinas tbody tr').length);
console.log('ver-mais é filho do card (não do tbody):', !!main.querySelector('.painel-disciplinas-card > [data-painel-vermais]'));
console.log('rodape tem acoes à direita + etiqueta:', !!main.querySelector('.fila-rodape .etiqueta'), !!main.querySelector('.fila-rodape .fila-acoes'));
