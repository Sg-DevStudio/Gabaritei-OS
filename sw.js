...
const CACHE = 'estudos-v161-sync-convergencia';
...
const ESTATICOS = [
  ...
  './js/frases.js',
  './css/styles.css?v=20260724-sync-convergencia1',
  './js/domain.js?v=20260721-disc-delete1',
  './js/store.js?v=20260724-sync-convergencia1',
  './js/sync.js?v=20260718h-seguranca-escala',
  './js/remote-state.js?v=20260718h-seguranca-escala',
  './js/firebase-sync.js?v=20260724-sync-convergencia1',
  ...
  './js/app.js?v=20260724-sync-convergencia1',
  './icons/icone.svg',
  './icons/icone-192.png',
  './icons/icone-512.png'
];
