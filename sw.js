...
const CACHE = 'estudos-v169-integridade-abas';
...
const ESTATICOS = [
  ...
  './js/frases.js',
  './css/styles.css?v=20260909b-integridade-abas',
  './js/domain.js?v=20260909b-integridade-abas',
  './js/store.js?v=20260909b-integridade-abas',
  './js/sync.js?v=20260718h-seguranca-escala',
  './js/remote-state.js?v=20260718h-seguranca-escala',
  './js/firebase-sync.js?v=20260909b-integridade-abas',
  ...
  './js/app.js?v=20260909b-integridade-abas',
  './icons/icone.svg',
  './icons/icone-192.png',
  './icons/icone-512.png'
];
