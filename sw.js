...
const CACHE = 'estudos-v44';
const ESTATICOS = [
  './',
  './index.html',
  './manifest.json',
  './css/styles.css?v=20260614h-login-multiusuario',
  './js/frases.js',
  './js/domain.js',
  './js/store.js',
  './js/sync.js',
  ...
  './js/timer.js',
  './js/charts.js',
  './data/catalogo-editais.js?v=20260614h-login-multiusuario',
  './js/app.js?v=20260614h-login-multiusuario',
  './icons/icone.svg'
];
