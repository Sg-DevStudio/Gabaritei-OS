...
const CACHE = 'estudos-v45';
const ESTATICOS = [
  './',
  './index.html',
  './manifest.json',
  './css/styles.css?v=20260614i-catalogo-pedidos',
  './js/frases.js',
  './js/domain.js',
  './js/store.js',
  './js/sync.js',
  ...
  './js/timer.js',
  './js/charts.js',
  './data/catalogo-editais.js?v=20260614i-catalogo-pedidos',
  './js/app.js?v=20260614i-catalogo-pedidos',
  './icons/icone.svg'
];
